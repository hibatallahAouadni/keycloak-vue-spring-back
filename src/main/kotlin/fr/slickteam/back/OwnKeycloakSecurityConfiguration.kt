...
class OwnKeycloakSecurityConfiguration {
    ...
    class KeycloakConfigurationAdapter : KeycloakWebSecurityConfigurerAdapter() {
        ...
        override fun configure(http: HttpSecurity) {
            http
                    ...
                    .and().apply(CommonSpringKeycloakTutorialsSecuritAdapter())
    ...
    class CommonSpringKeycloakTutorialsSecuritAdapter : AbstractHttpConfigurer<CommonSpringKeycloakTutorialsSecuritAdapter, HttpSecurity>() {
